...
if ($results.Count -gt 0) {
    Write-Information "Analysis of your code threw $($results.Count) warnings or errors. Please go back and check your code."
    exit 1
}
else {
    Write-Information 'Awesome code! No issues found!' -Foregroundcolor green
}